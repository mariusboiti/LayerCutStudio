...
$path = Join-Path (Get-Location) 'patch-fontsizepx.diff'
...
git add -A
git commit -m "apply: rename fontSize -> fontSizePx (evit TDZ/coliziuni)"
git tag -f safe-after-fontsize-rename